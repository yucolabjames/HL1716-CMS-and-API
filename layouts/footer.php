     <footer>
        <div class="container">
            <div class="clearfix">
                ...
                <div class="col-xs-12 col-sm-4 widget-link">
                    <ul>
                        <li><a href="">版權</a></li> 
                        <li><a href="">免責聲明</a></li> 
                        <li><a href="">私隱政策聲明</a></li> 
                        <li><a href="">網頁指南</a></li>
                    </ul>
                </div>
                ...
                <div class="col-xs-12 col-sm-4 widget-contact">
                   <ul>
                        <li>地址: 九龍塘浸會大學道</li>
                        <li>開放時間 : 星期一至日上午10時至下午7時</li>
                        <li>聯絡電話 : 852-35008335</li>
                        <li>電郵地址 : info@bu.com</li>
                    </ul>
                </div>
            </div>

            <div class="copyright text-center">BU©版權所有2018 。</div>
        </div>
    </footer>
    </div>
    ...
    <script src="js/vendor/parallax.js-1.5.0/parallax.min.js"></script>
    ...
    <script src="js/vendor/parallax.js-1.5.0/parallax.js"></script>
