...
class Contact extends Common
{
    ...
    public function index(){
        ...
        ->where($where)
        ->field('c.id,c.header,c.coordinate,c.tel,c.email,a.address,a.office_hours,a.header_title,a.header_content,b.language')
        ->paginate(array('list_rows'=>config('list_rows'),'page'=>$page,'type'=>'Bootstrap'))
        ->toArray();

        #图片访问域名
        $infoArray['domain'] = $this->upload_host;
    ...
    public function save(){
        ...
        if ($res || $res === 0) {
            ...
            #添加日志
            $this->logs('Modify contact us', 'Modify contact us',2);
